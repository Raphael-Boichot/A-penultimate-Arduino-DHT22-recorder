...
- Some [male pin headers](https://fr.aliexpress.com/item/1005006104110168.html). The clearance with the Arduino Uno shield is tight, but triming the pins below the PCB is enough to go with regular 11 mm pin headers for the short board. The long one requires 17 mm pins headers;
